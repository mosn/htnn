...
var httpfilterpolicylog = logf.Log.WithName("httpfilterpolicy-resource")
...
func (r *HTTPFilterPolicy) Default() {
	httpfilterpolicylog.Info("default", "name", r.Name)
}
...
func (r *HTTPFilterPolicy) ValidateCreate() (admission.Warnings, error) {
	httpfilterpolicylog.Info("validate create", "name", r.Name)
...
func (r *HTTPFilterPolicy) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	httpfilterpolicylog.Info("validate update", "name", r.Name)
...
func (r *HTTPFilterPolicy) ValidateDelete() (admission.Warnings, error) {
	httpfilterpolicylog.Info("validate delete", "name", r.Name)

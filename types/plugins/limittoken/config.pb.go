...
const file_types_plugins_limittoken_config_proto_rawDesc = "" +
	"\n" +
	"%types/plugins/limittoken/config.proto\x12\x18types.plugins.limittoken\x1a\x1egoogle/protobuf/duration.proto\x1a\x17validate/validate.proto\"\xbe\x03\n" +
	"\x06Config\x12#\n" +
	...
	"tokenStats\x12\x1c\n" +
	"\ttokenizer\x18\x06 \x01(\tR\ttokenizer\x12J\n" +
	"\fgjson_config\x18d \x01(\v2%.types.plugins.limittoken.GjsonConfigH\x00R\vgjsonConfig\x12+\n" +
	"\x11streaming_enabled\x18\a \x01(\bR\x10streamingEnabledB\x17\n" +
	"\x10extractor_config\x12\x03\xf8B\x01\"\xfb\x03\n" +
	"\x04Rule\x12(\n" +

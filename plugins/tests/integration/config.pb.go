...
func (x *BadPluginConfig) Reset() {
	*x = BadPluginConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plugins_tests_integration_config_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BadPluginConfig) Descriptor() ([]byte, []int) {
	return file_plugins_tests_integration_config_proto_rawDescGZIP(), []int{1}
}
...
var file_plugins_tests_integration_config_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x65, 0x6e, 0x63, 0x6f, 0x64,
	...
	0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22,
	0x61, 0x0a, 0x0f, 0x42, 0x61, 0x64, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x73, 0x65, 0x42, 0x28, 0x5a, 0x26, 0x6d, 0x6f, 0x73, 0x6e, 0x2e, 0x69, 0x6f, 0x2f, 0x68, 0x74,
	0x6e, 0x6e, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x73,
...
var file_plugins_tests_integration_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_plugins_tests_integration_config_proto_goTypes = []interface{}{
	(*Config)(nil),          // 0: plugins.tests.integration.Config
	(*BadPluginConfig)(nil), // 1: plugins.tests.integration.BadPluginConfig
}
...
func file_plugins_tests_integration_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plugins_tests_integration_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
